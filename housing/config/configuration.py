...
DataTransformationConfig,DataValidationConfig,ModelTrainerConfig,ModelEvaluaionConfig,ModelPusherConfig
...
class Configuration:
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            ...
            logging.info(f"Data transformation config: {data_tansformation_config}")
            return data_tansformation_config
        except Exception as e:
            raise HousingException(e,sys) from e
    ...
    def get_model_evaluation_config(self) -> ModelEvaluaionConfig:
        try:
            pass
        except Exception as e:
            raise HousingException(e,sys) from e
